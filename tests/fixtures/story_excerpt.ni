...
starting	final	comment
wondering	asking	"'I wonder,' says the lady."

Table of Fitting Remarks
starting	final	comment
fitting	trying	"'Let us see if it fits,' says the lady."

Table of Theodora Checking Remarks
starting	final	comment
theodora	lucinda	"'Theodora, come here,' says the lady."

Table of Lucinda Checking Remarks
starting	final	comment
lucinda	cinderella	"'Lucinda, come here,' says the lady."

Table of Cinderella Checking Remarks
starting	final	comment
cinderella	ending	"'Cinderella, come here,' says the lady."
